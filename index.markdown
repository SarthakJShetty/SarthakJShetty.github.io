...
During grad school, I was a Research Intern at [Intel Labs](https://www.intel.in/content/www/in/en/research/overview.html), in the Silicon and Systems Prototyping Labs, where I worked on RGB-D and monocular SLAM systems. I developed algorithms for pose estimation, sparse map storage and retrieval, trajectory prediction with Kalman Filters, and visual feature extraction.
